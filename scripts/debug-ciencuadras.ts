...
async function debugCiencuadras() {
  console.log('🔍 DEBUGGING CIENCUADRAS SCRAPER\n');
  console.log('=' .repeat(60));

  // Crear source y rate limiter para CiencuadrasScraper
  ...
  try {
    ...
    if (properties.length === 0) {
      ...
      console.log('   - Problemas con la URL de búsqueda');
      return;
    }
    ...
    console.log('\n💡 POSIBLES SOLUCIONES:');
    console.log('   1. Verificar conectividad a Ciencuadras');
    ...
    console.log('   5. Revisar la URL de búsqueda');
  }
}

// Ejecutar debug
debugCiencuadras().catch(console.error);
